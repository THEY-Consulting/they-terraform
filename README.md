...
| wait_for_capacity_timeout          | string       | A maximum duration that Terraform should wait for ASG instances to be healthy before timing out. Setting this to \"0\" causes Terraform to skip all Capacity Waiting behavior | no       | `"10m"`                                                                   |
