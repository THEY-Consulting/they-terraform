...
| target_groups.\*.path_patterns     | list(string) | URL path patterns on port 443 (HTTPs) that will be forwarded to the target group                                                                                        | no       | `null`                                                                    |
| target_groups.\*.priority          | number       | The priority for the rule between 1 and 50000. Leaving it unset will automatically set the rule with next available priority after the currently existing highest rule. | no       | `null`                                                                    |
