...
| web.cache_file_extensions                    | list(string) | List of file extensions that will be cached and served directly though front door, only relevant for web/frontend usage                                          | no       | `["css", "js", "ico", "png", "jpeg", "jpg", "gif", "map", "svg"]`                                                                                 |
