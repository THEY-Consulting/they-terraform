...
| target_groups.\*.path_patterns_forwarded_to_target_group_on_default_port | list(string) | URL path patterns on port 443 (HTTPs) that will be forwarded to the target group                                                                                        | no       | `null`                                                                    |
