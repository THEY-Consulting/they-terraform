...
| trust_store_arn                                                          | string       | Trust store ARN of default ALB listener (443/https) used for mutual authentication via mTLS                                                                             | no       | `null`                                                                    |
...
| backup_integrity_name                       | string       | Lowercase resource prefix (1-28 characters); required when enabled                       | no       | `null`                                                                                                       |
...
| vm_image.plan                         | object       | Purchase-plan information for Marketplace images that require it (e.g. FreeBSD).                 | no       | `null`                                                                                 |
| vm_image.plan.name                    | string       | Plan name (typically equal to the SKU)                                                           | no       |                                                                                        |
| vm_image.plan.product                 | string       | Plan product (typically equal to the offer)                                                      | no       |                                                                                        |
| vm_image.plan.publisher               | string       | Plan publisher                                                                                   | no       |                                                                                        |
