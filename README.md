...
| container_app_jobs.name                                                       | string       | Name of the container app job                                                                                                                   | yes      |             |
| container_app_jobs.tags                                                       | map(string)  | Tags specific to this job                                                                                                                       | no       |             |
| container_app_jobs.workload_profile_name                                      | string       | The name of the Workload Profile in the Container App Environment to place this job                                                             | no       |             |
| container_app_jobs.replica_timeout                                            | number       | Maximum time in seconds to wait for a replica to complete                                                                                       | no       | `1800`      |
| container_app_jobs.replica_retry_limit                                        | number       | Maximum number of times to retry a failed replica                                                                                               | no       | `0`         |
| container_app_jobs.manual_trigger_config                                      | object       | Configuration for manual jobs (exactly one trigger config must be provided)                                                                     | no       |             |
| container_app_jobs.manual_trigger_config.parallelism                          | number       | Number of parallel executions                                                                                                                   | no       | `1`         |
| container_app_jobs.manual_trigger_config.replica_completion_count             | number       | Number of replicas that need to complete                                                                                                        | no       | `1`         |
| container_app_jobs.schedule_trigger_config                                    | object       | Configuration for scheduled jobs (exactly one trigger config must be provided)                                                                  | no       |             |
| container_app_jobs.event_trigger_config                                       | object       | Configuration for event-driven jobs (exactly one trigger config must be provided)                                                               | no       |             |
| container_app_jobs.event_trigger_config.parallelism                           | number       | Number of parallel executions                                                                                                                   | no       | `1`         |
| container_app_jobs.event_trigger_config.replica_completion_count              | number       | Number of replicas that need to complete                                                                                                        | no       | `1`         |
| container_app_jobs.event_trigger_config.scale                                 | object       | Scaling configuration for event-driven jobs                                                                                                     | yes      |             |
| container_app_jobs.event_trigger_config.scale.min_executions                  | number       | Minimum number of executions                                                                                                                    | no       | `0`         |
| container_app_jobs.event_trigger_config.scale.max_executions                  | number       | Maximum number of executions                                                                                                                    | no       | `10`        |
| container_app_jobs.event_trigger_config.scale.rules                           | list(object) | List of scaling rules                                                                                                                           | yes      |             |
| container_app_jobs.event_trigger_config.scale.rules.\*.name                   | string       | Name of the scaling rule                                                                                                                        | yes      |             |
| container_app_jobs.event_trigger_config.scale.rules.\*.type                   | string       | Type of the scaling rule                                                                                                                        | yes      |             |
| container_app_jobs.event_trigger_config.scale.rules.metadata                  | map(string)  | Metadata for the scaling rule                                                                                                                   | yes      |             |
| container_app_jobs.event_trigger_config.scale.rules.auth                      | list(object) | Authentication configuration for the rule                                                                                                       | no       | `[]`        |
| container_app_jobs.event_trigger_config.scale.rules.auth.\*.secret_name       | string       | Name of the secret containing auth information                                                                                                  | yes      |             |
| container_app_jobs.event_trigger_config.scale.rules.auth.\*.trigger_parameter | string       | Parameter name for the trigger                                                                                                                  | yes      |             |
| container_app_jobs.schedule_trigger_config.cron_expression                    | string       | Cron expression for scheduling (e.g., "0 2 * * *")                                                                                              | yes      |             |
| container_app_jobs.schedule_trigger_config.parallelism                        | number       | Number of parallel executions                                                                                                                   | no       | `1`         |
| container_app_jobs.schedule_trigger_config.replica_completion_count           | number       | Number of replicas that need to complete                                                                                                        | no       | `1`         |
| container_app_jobs.template                                                   | object       | Container template configuration                                                                                                                | yes      |             |
| container_app_jobs.template.containers                                        | set(object)  | Set of container configurations                                                                                                                 | yes      |             |
| container_app_jobs.template.containers.\*.name                                | string       | Name of the container                                                                                                                           | yes      |             |
| container_app_jobs.template.containers.\*.image                               | string       | Container image name                                                                                                                            | yes      |             |
| container_app_jobs.template.containers.\*.cpu                                 | string       | CPU allocation (e.g., "0.25", "1")                                                                                                              | yes      |             |
| container_app_jobs.template.containers.\*.memory                              | string       | Memory allocation (e.g., "0.5Gi", "2Gi")                                                                                                        | yes      |             |
| container_app_jobs.template.containers.\*.command                             | list(string) | Override the default command                                                                                                                    | no       |             |
| container_app_jobs.template.containers.\*.args                                | list(string) | Override the default arguments                                                                                                                  | no       |             |
| container_app_jobs.template.containers.\*.env                                 | list(object) | Environment variables                                                                                                                           | no       |             |
| container_app_jobs.template.containers.\*.env.\*.name                         | string       | Name of the environment variable                                                                                                                | yes      |             |
| container_app_jobs.template.containers.\*.env.\*.value                        | string       | Value of the environment variable                                                                                                               | no       |             |
| container_app_jobs.template.containers.\*.env.\*.secret_name                  | string       | Name of secret containing the value                                                                                                             | no       |             |
| container_app_jobs.identity                                                   | object       | Managed identity configuration                                                                                                                  | no       |             |
| container_app_jobs.identity.type                                              | string       | Type of identity (`SystemAssigned`, `UserAssigned`, or `SystemAssigned,UserAssigned`)                                                           | yes      |             |
| container_app_jobs.identity.identity_ids                                      | list(string) | List of user-assigned identity IDs                                                                                                              | no       |             |
| container_app_jobs.secret                                                     | list(object) | List of secrets for the job                                                                                                                     | no       |             |
| container_app_jobs.secret.\*.name                                             | string       | Name of the secret                                                                                                                              | yes      |             |
| container_app_jobs.secret.\*.value                                            | string       | Value of the secret                                                                                                                             | no       |             |
| container_app_jobs.secret.\*.key_vault_secret_id                              | string       | Key Vault secret ID                                                                                                                             | no       |             |
| container_app_jobs.secret.\*.identity                                         | string       | Identity to use for Key Vault access                                                                                                            | no       |             |
| container_app_jobs.registry                                                   | list(object) | List of container registries for private images                                                                                                 | no       |             |
| container_app_jobs.registry.\*.server                                         | string       | Registry server URL                                                                                                                             | yes      |             |
| container_app_jobs.registry.\*.username                                       | string       | Registry username                                                                                                                               | no       |             |
| container_app_jobs.registry.\*.password_secret_name                           | string       | Name of secret containing registry password                                                                                                     | no       |             |
| container_app_jobs.registry.\*.identity                                       | string       | Identity to use for registry authentication                                                                                                     | no       |             |

##### Outputs

| Output                                             | Type         | Description                                                       |
|----------------------------------------------------|--------------|-------------------------------------------------------------------|
| container_app_jobs                                 | list(object) | Map of container app jobs with their details                      |
| container_app_jobs.\*.id                           | string       | The ID of the container app job                                   |
| container_app_jobs.\*.name                         | string       | The name of the container app job                                 |
| container_app_jobs.\*.resource_group_name          | string       | The resource group name where the job is deployed                 |
| container_app_jobs.\*.container_app_environment_id | string       | The ID of the Container App Environment where the job is deployed |
...
module "frontdoor_web" {
  ...
  web = {
    ...
    cache_file_extensions = ["css", "js", "ico", "png", "jpeg", "jpg", "gif", "map", "svg"]
  }
...
| web.cache_file_extensions                    | list(string) | List of file extensions that will be cached and served directly through front door, only relevant for web/frontend usage                                         | no       | `["css", "js", "ico", "png", "jpeg", "jpg", "gif", "map", "svg"]`                                                                                 |
...
| cache_settings                               | object       | Cache settings for the Front Door, only relevant for web/frontend usage                                                                                          | no       | `{ query_string_caching_behavior = "IgnoreQueryString", compression_enabled = true }` |
