...
| prod_instance_type  | string       | Instance type used to deploy production instances                                                                              | yes      |                 |
| dev_instance_type   | string       | Instance type used to deploy instances in dev environment                                                                      | yes      |                 |
